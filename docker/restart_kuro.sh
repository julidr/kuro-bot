...
echo "Stopping Kuro Bot Service"
docker service rm kuro-bot

echo "Removing Kuro Bot Logging Configs"
docker config rm kuro-bot-logs

echo "Removing Kuro Bot Secrets"
docker secret rm kuro-bot-secret
