...
class Event:
    ...
    EVENT_BANNER_URL = 'https://cdn.starira.xyz/api/assets/ww/res_en/res/event_permanent/banner/event_banner_{0}.png'
...
class Challenge(Event):
    ...
    CHALLENGE_ICON_URL = 'https://cdn.starira.xyz/api/assets/jp/res/item_root/large/1_{0}.png'
...
class Boss(Event):
    ...
    ENEMY_ICON_URL = 'https://cdn.starira.xyz/api/assets/jp/res/icon/enemy/{0}.png'
